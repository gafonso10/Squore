...
public enum Brand
{
  ...
  WinnerPadel (SportType.Padel, R.string.app_name_short_brand__WinnerPadel,15, R.drawable.brand_padel_splash__winnerpadel, R.id.sb_branded_logo_ar400, R.color.brand_padel_bg_color, R.string.CUSTOM_RECEIVER_APP_ID_brand_shared, R.array.colorSchema__WinnerPadel, 4000, "https://tennispadel.double-yellow.be", "06d7511e-f00a-4d82-b10b-2c8629e67dc8", R.raw.changelog_tennispadel),
    ;
